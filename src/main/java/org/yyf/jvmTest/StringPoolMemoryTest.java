...
/**
 * Created by tobi on 16-10-9. -XX:MaxPermSize=1K -Xmx5m -Xms5m -XX:+HeapDumpOnOutOfMemoryError
 * 堆内存溢出之前导出堆快照 -XX:HeapDumpPath=制定地址 默认在启动java的目录下，名字叫java_pid.hpro 用jvivsualm加载分析
 * 常量池的实际实现是在堆内存中……
 */
